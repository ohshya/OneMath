...
void module1::botones(){
    if(global::m1[0]==0){
        ui->B0->setStyleSheet("#B0{background: transparent; background-image: url(:/assets/iconos/nH.png);}");
    }if(global::m1part==1){
        ui->B1->setStyleSheet("#B1{background: transparent; background-image: url(:/assets/iconos/n10H.png);}");
    }if(global::m1part==2){
        ui->B2->setStyleSheet("#B2{background: transparent; background-image: url(:/assets/iconos/n2H.png);}");
    }if(global::m1part==3){
        ui->B3->setStyleSheet("#B3{background: transparent; background-image: url(:/assets/iconos/n8H.png);}");
    }if(global::m1part==4){
        ui->B4->setStyleSheet("#B4{background: transparent; background-image: url(:/assets/iconos/n16H.png);}");
    }
}
