...
{   
    ...
    case 0: style = "#nextPart{image: url(:/buttons/buttons/0ok.png);}"; break;
    case 1: style = "#nextPart{image: url(:/buttons/buttons/2ok.png);}"; break;
    case 2: style = "#nextPart{image: url(:/buttons/buttons/4ok.png);}"; break;
    case 3: style = "#nextPart{image: url(:/buttons/buttons/6ok.png);}"; break;
    case 4: style = "#nextPart{image: url(:/buttons/buttons/7ok.png);}"; break;
    default: break;
    }
