...
{
    QString style = QString("#nextPart{image: url(:/buttons/buttons/%1ok.png);}").arg(global::m2points);
...
{
    ui->explainConjunt->setStyleSheet(QString("border-image: url(:/Conjuntos/CA.png);"));
}

void module2test::on_conjuntoB_clicked()
{
    ui->explainConjunt->setStyleSheet(QString("border-image: url(:/Conjuntos/CB.png);"));
}

void module2test::on_conjuntoC_clicked()
{
    ui->explainConjunt->setStyleSheet(QString("border-image: url(:/Conjuntos/CC.png);"));
}

void module2test::on_op1_clicked()
{
    ui->explainConjunt2->setStyleSheet("border-image: url(:/Conjuntos/O1.png);");
}

void module2test::on_op2_clicked()
{
    ui->explainConjunt2->setStyleSheet("border-image: url(:/Conjuntos/O2.png);");
}

void module2test::on_op3_clicked()
{
    ui->explainConjunt2->setStyleSheet("border-image: url(:/Conjuntos/O3.png);");
}

void module2test::on_op4_clicked()
{
    ui->explainConjunt2->setStyleSheet("border-image: url(:/Conjuntos/O4.png);");
}

void module2test::on_op5_clicked()
{
    ui->explainConjunt2->setStyleSheet("border-image: url(:/Conjuntos/O5.png);");
}
